...
fun <ON, T> ON.blur(callback: (event: Event) -> Unit) where ON: OnReceiver<T>, T: EventReceiver =
        event("blur", eventType = Event::class, callback = callback)
fun <ION, T> ION.blur(callback: () -> Unit) where ION: OnImmediateReceiver<T>, T: EventReceiver = event("blur", callback)

fun <ON, T> ON.focus(callback: (event: Event) -> Unit) where ON: OnReceiver<T>, T: EventReceiver =
        event("focus", eventType = Event::class, callback = callback)
fun <ION, T> ION.focus(callback: () -> Unit) where ION: OnImmediateReceiver<T>, T: EventReceiver = event("focus", callback)

fun <ON, T> ON.focusin(callback: (event: Event) -> Unit) where ON: OnReceiver<T>, T: EventReceiver =
        event("focusin", eventType = Event::class, callback = callback)
fun <ION, T> ION.focusin(callback: () -> Unit) where ION: OnImmediateReceiver<T>, T: EventReceiver = event("focusin", callback)

fun <ON, T> ON.focusout(callback: (event: Event) -> Unit) where ON: OnReceiver<T>, T: EventReceiver =
        event("focusout", eventType = Event::class, callback = callback)
fun <ION, T> ION.focusout(callback: () -> Unit) where ION: OnImmediateReceiver<T>, T: EventReceiver = event("focusout", callback)


// Frame / Object Events TODO: define eventtype
fun <ON, T> ON.abort(callback: (event: Event) -> Unit) where ON: OnReceiver<T>, T: EventReceiver =
        event("abort", eventType = Event::class, callback = callback)
fun <ION, T> ION.abort(callback: () -> Unit) where ION: OnImmediateReceiver<T>, T: EventReceiver = event("abort", callback)

fun <ON, T> ON.beforeunload(callback: (event: Event) -> Unit) where ON: OnReceiver<T>, T: EventReceiver =
        event("beforeunload", eventType = Event::class, callback = callback)
fun <ION, T> ION.beforeunload(callback: () -> Unit) where ION: OnImmediateReceiver<T>, T: EventReceiver = event("beforeunload", callback)

fun <ON, T> ON.error(callback: (event: Event) -> Unit) where ON: OnReceiver<T>, T: EventReceiver =
        event("error", eventType = Event::class, callback = callback)
fun <ION, T> ION.error(callback: () -> Unit) where ION: OnImmediateReceiver<T>, T: EventReceiver = event("error", callback)
fun <ON, T> ON.hashchange(callback: (event: Event) -> Unit) where ON: OnReceiver<T>, T: EventReceiver =
        event("hashchange", eventType = Event::class, callback = callback)
fun <ION, T> ION.hashchange(callback: () -> Unit) where ION: OnImmediateReceiver<T>, T: EventReceiver = event("hashchange", callback)
fun <ON, T> ON.load(callback: (event: Event) -> Unit) where ON: OnReceiver<T>, T: EventReceiver =
        event("load", eventType = Event::class, callback = callback)
fun <ION, T> ION.load(callback: () -> Unit) where ION: OnImmediateReceiver<T>, T: EventReceiver = event("load", callback)
fun <ON, T> ON.pageshow(callback: (event: Event) -> Unit) where ON: OnReceiver<T>, T: EventReceiver =
        event("pageshow", eventType = Event::class, callback = callback)
fun <ION, T> ION.pageshow(callback: () -> Unit) where ION: OnImmediateReceiver<T>, T: EventReceiver = event("blur", callback)
fun <ON, T> ON.pagehide(callback: (event: Event) -> Unit) where ON: OnReceiver<T>, T: EventReceiver =
        event("pagehide", eventType = Event::class, callback = callback)
fun <ION, T> ION.pagehide(callback: () -> Unit) where ION: OnImmediateReceiver<T>, T: EventReceiver = event("pagehide", callback)
fun <ON, T> ON.resize(callback: (event: Event) -> Unit) where ON: OnReceiver<T>, T: EventReceiver =
        event("resize", eventType = Event::class, callback = callback)
fun <ION, T> ION.resize(callback: () -> Unit) where ION: OnImmediateReceiver<T>, T: EventReceiver = event("resize", callback)
fun <ON, T> ON.scroll(callback: (event: Event) -> Unit) where ON: OnReceiver<T>, T: EventReceiver =
        event("scroll", eventType = Event::class, callback = callback)
fun <ION, T> ION.scroll(callback: () -> Unit) where ION: OnImmediateReceiver<T>, T: EventReceiver = event("scroll", callback)
fun <ON, T> ON.unload(callback: (event: Event) -> Unit) where ON: OnReceiver<T>, T: EventReceiver =
        event("unload", eventType = Event::class, callback = callback)
fun <ION, T> ION.unload(callback: () -> Unit) where ION: OnImmediateReceiver<T>, T: EventReceiver = event("unload", callback)


// Form Events TODO: define eventtypes
fun <ON, T> ON.change(callback: (event: Event) -> Unit) where ON: OnReceiver<T>, T: EventReceiver =
        event("change", eventType = Event::class, callback = callback)
fun <ION, T> ION.change(callback: () -> Unit) where ION: OnImmediateReceiver<T>, T: EventReceiver = event("change", callback)
fun <ON, T> ON.input(callback: (event: Event) -> Unit) where ON: OnReceiver<T>, T: EventReceiver =
        event("input", eventType = Event::class, callback = callback)
fun <ION, T> ION.input(callback: () -> Unit) where ION: OnImmediateReceiver<T>, T: EventReceiver = event("input", callback)
fun <ON, T> ON.invalid(callback: (event: Event) -> Unit) where ON: OnReceiver<T>, T: EventReceiver =
        event("invalid", eventType = Event::class, callback = callback)
fun <ION, T> ION.invalid(callback: () -> Unit) where ION: OnImmediateReceiver<T>, T: EventReceiver = event("invalid", callback)
fun <ON, T> ON.reset(callback: (event: Event) -> Unit) where ON: OnReceiver<T>, T: EventReceiver =
        event("reset", eventType = Event::class, callback = callback)
fun <ION, T> ION.reset(callback: () -> Unit) where ION: OnImmediateReceiver<T>, T: EventReceiver = event("reset", callback)
fun <ON, T> ON.search(callback: (event: Event) -> Unit) where ON: OnReceiver<T>, T: EventReceiver =
        event("search", eventType = Event::class, callback = callback)
fun <ION, T> ION.search(callback: () -> Unit) where ION: OnImmediateReceiver<T>, T: EventReceiver = event("search", callback)
fun <ON, T> ON.select(callback: (event: Event) -> Unit) where ON: OnReceiver<T>, T: EventReceiver =
        event("select", eventType = Event::class, callback = callback)
fun <ION, T> ION.select(callback: () -> Unit) where ION: OnImmediateReceiver<T>, T: EventReceiver = event("select", callback)
fun <ON, T> ON.submit(callback: (event: Event) -> Unit) where ON: OnReceiver<T>, T: EventReceiver =
        event("submit", eventType = Event::class, callback = callback)
fun <ION, T> ION.submit(callback: () -> Unit) where ION: OnImmediateReceiver<T>, T: EventReceiver = event("submit", callback)

// Drag Events TODO: define eventtype
fun <ON, T> ON.drag(callback: (event: Event) -> Unit) where ON: OnReceiver<T>, T: EventReceiver =
        event("drag", eventType = Event::class, callback = callback)
fun <ION, T> ION.drag(callback: () -> Unit) where ION: OnImmediateReceiver<T>, T: EventReceiver = event("drag", callback)

fun <ON, T> ON.dragend(callback: (event: Event) -> Unit) where ON: OnReceiver<T>, T: EventReceiver =
        event("dragend", eventType = Event::class, callback = callback)
fun <ION, T> ION.dragend(callback: () -> Unit) where ION: OnImmediateReceiver<T>, T: EventReceiver = event("dragend", callback)
fun <ON, T> ON.dragenter(callback: (event: Event) -> Unit) where ON: OnReceiver<T>, T: EventReceiver =
        event("dragenter", eventType = Event::class, callback = callback)
fun <ION, T> ION.dragenter(callback: () -> Unit) where ION: OnImmediateReceiver<T>, T: EventReceiver = event("dragenter", callback)
fun <ON, T> ON.dragleave(callback: (event: Event) -> Unit) where ON: OnReceiver<T>, T: EventReceiver =
        event("dragleave", eventType = Event::class, callback = callback)
fun <ION, T> ION.dragleave(callback: () -> Unit) where ION: OnImmediateReceiver<T>, T: EventReceiver = event("dragleave", callback)
fun <ON, T> ON.dragover(callback: (event: Event) -> Unit) where ON: OnReceiver<T>, T: EventReceiver =
        event("dragover", eventType = Event::class, callback = callback)
fun <ION, T> ION.dragover(callback: () -> Unit) where ION: OnImmediateReceiver<T>, T: EventReceiver = event("dragover", callback)
fun <ON, T> ON.dragstart(callback: (event: Event) -> Unit) where ON: OnReceiver<T>, T: EventReceiver =
        event("dragstart", eventType = Event::class, callback = callback)
fun <ION, T> ION.dragstart(callback: () -> Unit) where ION: OnImmediateReceiver<T>, T: EventReceiver = event("dragstart", callback)
fun <ON, T> ON.drop(callback: (event: Event) -> Unit) where ON: OnReceiver<T>, T: EventReceiver =
        event("drop", eventType = Event::class, callback = callback)
fun <ION, T> ION.drop(callback: () -> Unit) where ION: OnImmediateReceiver<T>, T: EventReceiver = event("drop", callback)

// Clipboard Events TODO: define eventtype
fun <ON, T> ON.copy(callback: (event: Event) -> Unit) where ON: OnReceiver<T>, T: EventReceiver =
        event("copy", eventType = Event::class, callback = callback)
fun <ION, T> ION.copy(callback: () -> Unit) where ION: OnImmediateReceiver<T>, T: EventReceiver = event("copy", callback)

fun <ON, T> ON.cut(callback: (event: Event) -> Unit) where ON: OnReceiver<T>, T: EventReceiver =
        event("cut", eventType = Event::class, callback = callback)
fun <ION, T> ION.cut(callback: () -> Unit) where ION: OnImmediateReceiver<T>, T: EventReceiver = event("cut", callback)
fun <ON, T> ON.paste(callback: (event: Event) -> Unit) where ON: OnReceiver<T>, T: EventReceiver =
        event("paste", eventType = Event::class, callback = callback)
fun <ION, T> ION.paste(callback: () -> Unit) where ION: OnImmediateReceiver<T>, T: EventReceiver = event("paste", callback)

// Print Events TODO: define eventtype
fun <ON, T> ON.afterprint(callback: (event: Event) -> Unit) where ON: OnReceiver<T>, T: EventReceiver =
        event("afterprint", eventType = Event::class, callback = callback)
fun <ION, T> ION.afterprint(callback: () -> Unit) where ION: OnImmediateReceiver<T>, T: EventReceiver = event("afterprint", callback)

fun <ON, T> ON.beforeprint(callback: (event: Event) -> Unit) where ON: OnReceiver<T>, T: EventReceiver =
        event("beforeprint", eventType = Event::class, callback = callback)
fun <ION, T> ION.beforeprint(callback: () -> Unit) where ION: OnImmediateReceiver<T>, T: EventReceiver = event("beforeprint", callback)
...
fun <ON, T> ON.animationend(callback: (event: Event) -> Unit) where ON: OnReceiver<T>, T: EventReceiver =
        event("animationend", eventType = Event::class, callback = callback)
fun <ION, T> ION.animationend(callback: () -> Unit) where ION: OnImmediateReceiver<T>, T: EventReceiver = event("animationend", callback)

/** The event occurs when a CSS animation is repeated **/
fun <ON, T> ON.animationiteration(callback: (event: Event) -> Unit) where ON: OnReceiver<T>, T: EventReceiver =
        event("animationiteration", eventType = Event::class, callback = callback)
fun <ION, T> ION.animationiteration(callback: () -> Unit) where ION: OnImmediateReceiver<T>, T: EventReceiver = event("animationiteration", callback)

/** The event occurs when a CSS animation has started **/
fun <ON, T> ON.animationstart(callback: (event: Event) -> Unit) where ON: OnReceiver<T>, T: EventReceiver =
        event("animationstart", eventType = Event::class, callback = callback)
fun <ION, T> ION.animationstart(callback: () -> Unit) where ION: OnImmediateReceiver<T>, T: EventReceiver = event("animationstart", callback)

// Transition Events
/** The event occurs when a CSS transition has completed **/
fun <ON, T> ON.transitionend(callback: (event: Event) -> Unit) where ON: OnReceiver<T>, T: EventReceiver =
        event("transitionend", eventType = Event::class, callback = callback)
fun <ION, T> ION.transitionend(callback: () -> Unit) where ION: OnImmediateReceiver<T>, T: EventReceiver = event("transitionend", callback)
