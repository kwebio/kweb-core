...
class FomanticUIPlugin : KwebPlugin(dependsOn = setOf(jqueryCore)) {
    override fun decorate(startHead: StringBuilder, endHead: StringBuilder) {
        startHead.append("""
            ...
            <link rel="stylesheet" type="text/css" href="https://cdn.jsdelivr.net/npm/fomantic-ui@2.7.4/dist/fomantic.min.css">
            <script src="https://cdn.jsdelivr.net/npm/fomantic-ui@2.7.4/dist/fomantic.min.js"></script>
