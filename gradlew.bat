...
@rem Set read scope for the variables from windows NT shell
...
echo.
echo Please setString the JAVA_HOME variable in your environment to render the
...
:end
@rem End read scope for the variables from windows NT shell
